        ...
        loginForm.addEventListener("submit", async function (e) {
            ...
            try {
                ...
                if (result && result.success) {
                    ...
                    if (role === "admin") {
                        window.location.href = `${baseUrl}/pages/admin/user-management.html`;
                    } else if (role === "seller") {
                        window.location.href = `${baseUrl}/pages/seller/dashboard.html`;
                    } else if (role === "courier") {
                        window.location.href = `${baseUrl}/pages/courier/dashboard.html`;
                    } else if (role === "buyer") {
