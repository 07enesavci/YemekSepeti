        ...
        featuredGrid.innerHTML = sellers.map(seller => {
            ...
            <div class="restaurant-card" data-seller-id="${seller.id}" style="cursor: pointer;">
                ...
                <div class="card-content" style="padding: 1.5rem;">
                    ...
                    <a href="pages/buyer/seller-profile.html?id=${seller.id}" 
            ...
            document.querySelectorAll('.restaurant-card').forEach(card => {
                card.addEventListener('click', (e) => {
                    ...
                    if (!e.target.closest('a')) {
                        ...
                        const baseUrl = window.getBaseUrl ? window.getBaseUrl() : '';
                        window.location.href = `${baseUrl}/pages/buyer/seller-profile.html?id=${sellerId}`;
                    }
                });
            });
        }, 100);
...
// Sayfa yüklendiğinde restoranları yükle
