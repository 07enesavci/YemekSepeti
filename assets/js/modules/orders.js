...
async function renderOrders() {
    ...
    // Session'dan veya localStorage'dan userId'yi al
    let userId = null;
    
    try {
        // Session bilgisini kontrol etmeye çalış
        ...
        console.warn('Session bilgisi alınamadı');
    }
    
    // Eğer userId bulunamazsa, varsayılan 1 kullan
    if (!userId) {
        userId = 1;
    }
