...
async function showReviewModal(orderId) {
    try {
        ...
        // Modalın kapatma butonlarını manuel javascript ile de destekle (onclick bazen ezilebilir)
        const closeBtns = document.querySelectorAll('#review-modal .order-detail-modal-close, #review-modal .btn-secondary');
